...
| `runner-count`                                                                                                                                                               | Optional. Used only with the `start` mode. | Specifies the number of runners to start. Default 1. <br><br> When starting more than 1, all runners get the same GH label, which you use in jobs the same as a single runner. Stop mode will stop all runners with the same label. You can use this to start multiple runners for a matrix job to run on.<br><br> |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Description                                                                                                                                                                                                                               |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `label`                                                                                                                                                                      | Name of the unique label assigned to the runner(s). <br><br> The label is used in two cases: <br> - to use as the input of `runs-on` property for the following jobs; <br> - to remove the runner(s) from GitHub when it is not needed anymore. |
| `ec2-instance-id`                                                                                                                                                            | EC2 Instance Id of the created runner. If multiple instances were started, it will be a comma seperated list of EC2 Instance Id.<br><br> The id is used to terminate the EC2 instance when the runner is not needed anymore.                                                                                                       |

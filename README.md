...
| `instance-volume-size`                                                                                                                                                       | Required if you use the `start` mode.      | EBS Volume Size.                                                                                                                                                                                                                                                                                                                      |
...
| `github-runner-version`                                                                                                                                                      | Optional. Used only with the `start` mode. | GitHub runner releases version.<br><br>                                                                                                                                                                                                                                                                                               |
| `aws-nfs-logging`                                                                                                                                                            | Optional. Used only with the `start` mode. | Flag for enabling or disabling NFS logging.<br><br>                                                                                                                                                                                                                                                                                   |
| `aws-nfs-host`                                                                                                                                                               | Optional. Used only with the `start` mode. | NFS host in AWS for logging.<br><br>                                                                                                                                                                                                                                                                                                  |

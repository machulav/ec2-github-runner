...
`aws-resource-tags`                                                                                                                                                          | Optional. Used only with the `start` mode. | Specifies tags to add to the EC2 instance and any attached storge. <br><br> This field is a stringified JSON array of tag objects, each containing a Key and Value field (see Example below). <br><br> Setting this requires additional AWS permissions for the role launching the instance. |

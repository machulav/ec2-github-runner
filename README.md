...
| `quiet-period-seconds`                                                                                                                                                              | Optional. Used only with the `start` mode. | Specifies for how long the runner job should wait initially before registering the runner on GitHub.
<br><br>
  ...
  start-runner:
    ...
    steps:
      ...
      - name: Start EC2 runner
        id: start-ec2-runner
        uses: matheus-rosa/ec2-github-runner@v2
        with:
          mode: start
...
In [this discussion](https://github.com/matheus-rosa/ec2-github-runner/discussions/19), you can find feedback and examples from the users of the action.
